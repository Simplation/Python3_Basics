...
```
dic = {'name': ’Simplation', 'site': ‘[h](http://wuxiaolong.me/)ttp://www.baidu.com', 'code': 1024}
```
...
{'name': 'Simplation', 'site': '[http://www.baidu.com](http://www.baidu.com/)', 'code': 1024}
...
{'name': 'Simplation', 'site': '[http://www.baidu.com](http://www.baidu.com/)', 'code': 520}
```
...
{'name': 'Simplation', 'site': '[http://www.baidu.com](http://www.baidu.com/)', 'code': 520, 'id': 1314}
```
...
{'name': 'Simplation', 'site': '[http://www.baidu.com](http://www.baidu.com/)’}
...
\>>> d = dict(id=1024, name='simplation', site='[http://www.baidu.com/](http://wuxiaolong.me/)')

\>>> print(d)

{'id': 1024, 'name': 'simplation', 'site': '[http://www.baidu.com/](http://wuxiaolong.me/)'}
...
dict_values(['Simplation', '[http://www.baidu.com](http://www.baidu.com/)', 1024])
```
